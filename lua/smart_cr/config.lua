	...
	endwise_cr = {
		...
		rules = {
			lua = {
				...
				{'then$',                'end', {'if_statement'}},
				{'do$',                  'end', {'for_statement', 'while_statement', 'do_statement'}},
				{'function.*%(.*%)$', 'end', {'function_call', 'function_definition', 'local_function', 'function_declaration'}},
			},
			matlab = {
				...
				{'function%s+%(.*%)$', 'end', {'ERROR', 'function_definition', 'function_declaration'}},
			},
			sh = {
